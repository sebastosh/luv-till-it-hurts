        ...
        <div class="panel-body">
                    ...
                    <div class="b2s-sidebar-head">
                        ...
                        <ul>
                            <li class="b2s-list-margin-left-10">
                                <i class="glyphicon glyphicon-th-list glyphicon-success"></i> <a href="admin.php?page=blog2social-post" class="b2s-sidebar-menu-item"><?php esc_html_e("Share Blog Post", "blog2social") ?></a> 
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="b2s-sidebar-head">
                        <div class="b2s-sidebar-head-text">
                            <?php esc_html_e("Content Curation", "blog2social") ?>
                        </div>
                        <ul>
                            <li class="b2s-list-margin-left-10">
                ...
                <div class="row">
                    ...
                    <div class="b2s-sidebar-head">
                        ...
                        <ul>
                            ...
                            <li class="b2s-list-margin-left-10">
                                <i class="glyphicon glyphicon-th-list glyphicon-success"></i> <a href="admin.php?page=blog2social-settings" class="b2s-sidebar-menu-item"><?php esc_html_e("Settings", "blog2social") ?></a> 
                            </li>
                            <li class="b2s-list-margin-left-10">
            ...
            <?php if (!B2S_System::isblockedArea('B2S_MENU_MODUL_RATING', B2S_PLUGIN_ADMIN)) { ?> 
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="b2s-sidebar-head">
                            <div class="b2s-sidebar-head-text">
                                <span class="glyphicon glyphicon-star glyphicon-success"></span> <?php esc_html_e("Rate it!", "blog2social"); ?> 
                            </div>
