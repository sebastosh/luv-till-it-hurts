...
<div class="col-md-12 pull-left b2s-post-menu del-padding-left">
    ...
    <a class="btn btn-<?php echo ($getPage == 'blog2social-sched') ? 'primary' : 'link'; ?> b2s-post-btn b2s-post-sched" href="admin.php?page=blog2social-sched"><?php esc_html_e('Scheduled Posts', 'blog2social') ?> <?php echo (!empty($isPremiumInfo) ? '<span class="label label-success">' . esc_html__("PREMIUM", "blog2social") . '</span>' : '' ); ?>  </a>
    <?php if ($getPage != "blog2social") { ?>
        ...
        <a class="btn btn-<?php echo ($getPage == 'blog2social-calendar') ? 'primary' : 'link'; ?> b2s-post-btn" href="admin.php?page=blog2social-calendar"><?php esc_html_e('Calendar', 'blog2social') ?> <?php echo (!empty($isPremiumInfo) ? '<span class="label label-success">' . esc_html__("PREMIUM", "blog2social") . '</span>' : '' ); ?>  </a>
