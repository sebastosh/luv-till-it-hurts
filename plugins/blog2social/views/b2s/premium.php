                        ...
                        <?php if (!B2S_System::isblockedArea('B2S_LICENSE_MODUL_EDIT', B2S_PLUGIN_ADMIN)) { ?> 
                            <h2 class="b2s-premium-h2"><?php esc_html_e('Your current license:', 'blog2social') ?>
                                ...
                                <?php if (B2S_PLUGIN_USER_VERSION == 0 && !defined("B2S_PLUGIN_TRAIL_END")) { ?>
                                    <a class="btn btn-sm btn-primary pull-right" href="<?php echo B2S_Tools::getSupportLink('feature'); ?>" target="_blank">   <?php esc_html_e('Try Blog2Social Premium 30 days for free', 'blog2social') ?></a>
                                <?php } ?>  
                            </h2>
